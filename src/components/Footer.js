        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-y-[30px] md:gap-y-[30px] gap-x-0 md:gap-x-[60px] items-start">
          ...
          <div className="flex flex-col justify-start items-start w-full">
            <div className="grid grid-cols-2 md:grid-cols-2 gap-x-[20px] sm:gap-x-[40px] gap-y-[10px] w-full">
              ...
              <ul className="space-y-[10px]">
                <li>
                  <Link to={langPath("/sectors")} className="font-saira text-white/90 text-[18px] sm:text-[20px] hover:text-[#FF8A00] transition duration-200 block py-[4px]">
                    Sectors
                  </Link>
                </li>
                <li>
          ...
          {/* CONTACTS */}
          <div className="flex flex-col justify-start items-start w-full">
            <h4 className="font-[Rajdhani] text-[26px] sm:text-[30px] font-[700] uppercase mb-[12px] text-white tracking-[1px]">
              Our Contacts
            </h4>
            ...
            <ul className="space-y-[12px] w-full">
              ...
              <li className="flex items-start font-saira text-white/90 text-[18px] sm:text-[20px]">
                <i className="fa-regular fa-envelope text-[22px] w-[26px] mr-[18px] text-white mt-[2px]"></i>
          ...
          <div className="flex flex-col justify-start items-start w-full">
            ...
            <div className="flex gap-[20px] mt-[14px] items-center flex-wrap">
              <a href="https://www.facebook.com/ACHISCAFF" target="_blank" rel="noreferrer" className="text-white hover:text-[#FF8A00] transition duration-200">
                <i className="fa-brands fa-facebook-f text-[22px]"></i>
              </a>
              <a href="https://www.instagram.com/achiscaffoldinglb" target="_blank" rel="noreferrer" className="text-white hover:text-[#FF8A00] transition duration-200">
                <i className="fa-brands fa-instagram text-[22px]"></i>
              </a>
              <a href="https://x.com/AchiScaffolding" target="_blank" rel="noreferrer" className="text-white hover:text-[#FF8A00] transition duration-200">
                <i className="fa-brands fa-x-twitter text-[22px]"></i>
              </a>
              <a href="https://www.linkedin.com/company/achi-scaffolding/" target="_blank" rel="noreferrer" className="text-white hover:text-[#FF8A00] transition duration-200">
                <i className="fa-brands fa-linkedin-in text-[22px]"></i>
              </a>
              <a href="https://www.tiktok.com/@achiscaffolding" target="_blank" rel="noreferrer" className="text-white hover:text-[#FF8A00] transition duration-200">
